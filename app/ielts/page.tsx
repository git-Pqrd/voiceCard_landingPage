...
export const metadata: Metadata = {
  title: "IELTS Speaking Practice | VoiceVocab — Active Learning for Band 7+",
  description:
    "IELTS & TOEFL speaking practice with AI. Explain vocabulary aloud, get instant feedback on fluency, vocabulary & coherence. Active learning + spaced repetition.",
  keywords:
    "IELTS speaking practice, IELTS band 7, IELTS speaking app, TOEFL speaking, spoken vocabulary practice, AI IELTS coach",
  alternates: { canonical: "https://VoiceVocab.com/ielts" },
};
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-left">
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-700 dark:text-slate-300 mb-6 sm:mb-8 font-medium leading-relaxed">
                ...
                . Explain vocabulary aloud. Get instant AI feedback on
                fluency, vocabulary, and coherence.
              </p>
              ...
              <div className="glass-card rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-6 md:p-8 overflow-hidden border border-slate-200 dark:border-slate-700">
                ...
                <div className="mb-5 sm:mb-6 p-3 sm:p-4 md:p-6 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700">
                  <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center flex-shrink-0">
                      <svg
                ...
                <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-3 sm:p-4 md:p-5 border border-green-200 dark:border-green-800">
                  ...
                  <p className="text-xs sm:text-sm md:text-base text-slate-700 dark:text-slate-300 mb-2 sm:mb-3">
                    &ldquo;Good use of cause-effect structure. Consider adding
                    specific examples (deforestation, pollution) to boost
                    lexical range. Fluency was strong with minimal hesitation.&rdquo;
                  </p>
        ...
        <section className="mb-12 sm:mb-16 md:mb-24">
          ...
          <div className="lg:hidden overflow-x-auto scrollbar-hide snap-x snap-mandatory py-4 px-6">
            <div className="flex gap-4" style={{ width: "max-content" }}>
              {IELTS_DRILLS.map((d) => (
                <DrillCard key={d.term} {...d} mobile />
              ))}
            </div>
          </div>
          <div className="hidden lg:grid lg:grid-cols-4 gap-4">
            {IELTS_DRILLS.map((d) => (
              <DrillCard key={d.term} {...d} />
            ))}
          </div>
        </section>
        ...
        <section id="how-it-works" className="mb-12 sm:mb-16 md:mb-24">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            <Step
              num={1}
              title="See an exam term"
              desc="High-value IELTS/TOEFL vocabulary."
            />
            <Step
              num={2}
              title="Speak out loud"
              desc="Explain it like you're answering an examiner."
            />
            <Step
              num={3}
              title="Get AI feedback"
              desc="Scored on fluency, vocabulary, and coherence."
            />
            <Step
              num={4}
              title="Repeat weak terms"
              desc="Spaced repetition until you nail them."
            />
          </div>
        </section>
        ...
        <section className="mb-12 sm:mb-16 md:mb-24">
          <div className="glass-card rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 lg:p-12">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-slate-800 dark:text-white mb-6 sm:mb-8 md:mb-10 text-center">
              Why VoiceVocab Works for IELTS
            </h2>
    ...
    <div className={wrapper}>
      <div
        className={`glass-card rounded-xl p-4 ${
          mobile ? `border-2 ${s.border}` : "border border-slate-200 dark:border-slate-700"
        } h-full shadow-none`}
      >
        ...
        <div className={`${s.feedbackBg} rounded-lg p-3 border ${s.feedbackBorder}`}>
